...
namespace MathTools.Algebra.Functions.Tests
{
    ...
    public class Log10Tests
    {
        ...
        public void EvalTest()
        {
            ...
            Assert.AreEqual(Math.Log10(0.4) / 3.8, formula.Eval(), error);

            formula = Formula.Parse("3.4/log10(0.8)");
            Assert.AreEqual(3.4 / Math.Log10(0.8), formula.Eval(), error);
        }
        ...
        public void EvalDerivativeTest()
        {
            ...
            Assert.AreEqual(-0.0188927, formula.EvalDerivative("x", new { x = 0.2 }), error);
        }
        ...
        public void GetDifferentialExpressionTest()
        {
            ...
            var formula = Formula.Parse("x^4*log10(x)");
